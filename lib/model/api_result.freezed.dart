...
abstract class $ApiResultCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? message, dynamic result});
}
...
class _$_ApiResult implements _ApiResult {
  const _$_ApiResult({this.message, this.result});
  ...
  @override
  String toString() {
    return 'ApiResult(message: $message, result: $result)';
  }
...
abstract class _ApiResult implements ApiResult {
  const factory _ApiResult({final String? message, final dynamic result}) =
      _$_ApiResult;
